...
export {}
declare global {
  const API_BASE: typeof import('@/config/env/ENV_AUTO_IMPORT.mjs')['API_BASE']
  const API_PAGE_SPEED_GET_INFO: typeof import('@/config/env/ENV_AUTO_IMPORT.mjs')['API_PAGE_SPEED_GET_INFO']
  const API_PAGE_SPEED_GET_PAGE_SPEED: typeof import('@/config/env/ENV_AUTO_IMPORT.mjs')['API_PAGE_SPEED_GET_PAGE_SPEED']
  ...
  const VALIDATION_URL: typeof import('@/config/env/ENV_AUTO_IMPORT.mjs')['VALIDATION_URL']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly API_BASE: UnwrapRef<typeof import('@/config/env/ENV_AUTO_IMPORT.mjs')['API_BASE']>
    readonly API_PAGE_SPEED_GET_INFO: UnwrapRef<typeof import('@/config/env/ENV_AUTO_IMPORT.mjs')['API_PAGE_SPEED_GET_INFO']>
    ...
    readonly VALIDATION_URL: UnwrapRef<typeof import('@/config/env/ENV_AUTO_IMPORT.mjs')['VALIDATION_URL']>
